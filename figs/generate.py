...
def druid_mem_usage_total():
    ...
    data = {
        'Raw data': {'x': [1,2,3,4,5,6,7],
                       'y': '1.4	2.6	3.8	5	6.2	7.4	8.6'.split() },
        'I^2-Oak': {'x': [1,2,3,4,5,6,7],
                                'y': '1.618098639	3.021213986	4.424329136	5.827444442	7.23055917	8.536017641	9.939132214'.split()},
        'I^2-legacy':{'x': [1,2,3,4,5,6,7],
                            'y':'1.644571222	3.269580618	4.886680782	6.519420322	8.136721686	9.753841683	11.40213157'.split()}
        }
...
def druid_ingest_30g():
    data = {
       'I^2-Oak': {'x': [1,2,3,4,5,6,7],
                   'y': '70,551.35	68,395.49	64,152.89	64,850.47	66,949.99	63,134.71	56,286.03'.split()},
        'I^2-legacy':{'x': [1,2,3,4,5,6,7],
                      'y':'69,565.41	60,234.64	61,969.90	56,938.86	45,232.01	44,988.15	29,921.51'.split()}
       }
